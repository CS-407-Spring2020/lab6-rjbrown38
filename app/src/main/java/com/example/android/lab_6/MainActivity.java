...
public class MainActivity extends FragmentActivity {
    ...
    private final LatLng mDestinationLatLng = new LatLng(43.07489, -89.404391);
    //private final LatLng mDestinationLatLng = new LatLng(mLastKnownLocation.getLatitude(), mLastKnownLocation.getLongitude());
